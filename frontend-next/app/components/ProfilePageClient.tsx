                                ...
                                {loadingUtilities ? (
                                    ...
                                    <ul className="profile-mini-list">
                                        {trackedApps.slice(0, 5).map((item) => (
                                            <li key={item.id}>
                                                <Link href={buildAnnouncementDetailPath(item.type, item.slug, 'profile_tracked')}>
                                                    {item.title}
                                                </Link>
                                ...
                                {loadingUtilities ? (
                                    ...
                                    <ul className="profile-mini-list">
                                        {notifications.slice(0, 5).map((item) => (
                                            <li key={item.id}>
                                                {item.slug ? (
                                                    <Link href={buildAnnouncementDetailPath(item.type, item.slug, 'profile_notifications')}>
                                                        {item.title}
                                                    </Link>
                                                ) : (
