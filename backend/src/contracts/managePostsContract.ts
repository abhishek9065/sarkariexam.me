import type { AnnouncementStatus, ContentType } from '../types.js';
...
export type ManagePostsStatusFilter = AnnouncementStatus | 'all';
...
export const cloneManagePostsWorkspaceSnapshot = (
    snapshot: ManagePostsWorkspaceSnapshot,
): ManagePostsWorkspaceSnapshot => JSON.parse(JSON.stringify(snapshot)) as ManagePostsWorkspaceSnapshot;
