                    ...
                    <section className="admin-workspace" id="admin-main" role="main" tabIndex={-1}>
                        ...
                        {activeAdminTab === 'analytics' ? (
                            ...
                            <ReviewQueueTab
                                ...
                                enableAdminReviewV3={enableAdminReviewV3}
                                canApproveAnnouncements={canApproveAnnouncements}
                                pendingSlaStats={pendingSlaStats}
                                pendingAnnouncements={pendingAnnouncements}
                                selectedIds={selectedIds}
                                selectedReviewTemplate={selectedReviewTemplate}
                                handleReviewTemplateSelect={handleReviewTemplateSelect}
                                reviewNoteTemplates={REVIEW_NOTE_TEMPLATES}
                                reviewBulkNote={reviewBulkNote}
                                setReviewBulkNote={setReviewBulkNote}
                                reviewScheduleAt={reviewScheduleAt}
                                setReviewScheduleAt={setReviewScheduleAt}
                                ...
                                handleBulkQaFix={handleBulkQaFix}
                                qaBulkLoading={qaBulkLoading}
                                selectedQaFixableCount={selectedQaFixableCount}
                                handleBulkQaFlag={handleBulkQaFlag}
                                selectedQaIssueCount={selectedQaIssueCount}
                                clearSelection={clearSelection}
                                getAnnouncementWarnings={getAnnouncementWarnings}
                                getReviewRisk={getReviewRisk}
                                reviewNotes={reviewNotes}
                                mutatingIds={mutatingIds}
                                setReviewNotes={setReviewNotes}
                                handleView={handleView}
                                handleEdit={handleEdit}
                                handleQaFix={handleQaFix}
                                handleQaFlag={handleQaFlag}
