...
test.describe('Homepage mobile tabs', () => {
    test('shows major sections in tabs and switches active panel', async ({ page }) => {
        ...
        await expect(page.locator('[data-testid="home-mobile-tabs"]')).toBeVisible();
        await expect(page.locator('[data-testid="home-v3-top-grid"]')).toBeHidden();
        ...
        await expect(page.locator('[data-testid="home-mobile-major-panel"]')).toBeVisible();
