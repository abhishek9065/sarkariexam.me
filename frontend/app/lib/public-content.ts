...
const resultAnnouncements: AnnouncementItem[] = [
  createAnnouncement('results', {
    ...
    title: 'UPSC Civil Services 2025 — Final Result Declared',
    ...
    legacyId: '1',
    shortInfo:
      'UPSC has declared the final result for Civil Services Examination 2025. A total of 933 candidates have been recommended for appointment to IAS, IFS, IPS, and other Central Services.',
    summary:
      'UPSC has declared the final result for Civil Services Examination 2025. A total of 933 candidates have been recommended for appointment to IAS, IFS, IPS, and other Central Services. The merit list is available on the UPSC official website.',
    detail: {
      theme: {
        accent: '#c62828',
        gradientFrom: '#b71c1c',
      ...
      heroStats: [
        { label: 'Category', value: 'Latest Result' },
      ...
      importantDates: [
        ...
        { label: 'Prelims Result', date: '25 Jun 2025', status: 'done' },
        { label: 'Mains Exam', date: 'Sep 2025', status: 'done' },
        { label: 'Mains Result', date: 'Dec 2025', status: 'done' },
        { label: 'Interview', date: 'Jan — Mar 2026', status: 'done' },
        { label: 'Final Result', date: '27 Mar 2026', status: 'active' },
      ],
      applicationFee: {
        title: 'Application Fee',
        rows: [
          { label: 'General / EWS', value: '₹100' },
          { label: 'OBC (Non-Creamy Layer)', value: '₹100' },
          { label: 'SC / ST / PH / Women', value: '₹0 (Exempted)' },
        ],
        note: 'Online Payment / SBI Cash Challan',
      },
      ageLimit: {
        summary: '21 — 32 years (General)',
        points: [
          'SC/ST: 37 years, OBC: 35 years, PH: 42 years.',
          'Age rules follow the original UPSC Civil Services 2025 notification.',
        ],
      },
      eligibility: [
        {
          title: 'Education',
          description: 'Graduation from any recognized university. Final year students are not eligible.',
        },
        {
          title: 'Age',
          description: '21 to 32 years (General). SC/ST: 37 years, OBC: 35 years, PH: 42 years.',
        },
        {
          title: 'Nationality',
          description: 'Must be a citizen of India for IAS/IPS. Other services allow Nepal/Bhutan/Tibetan refugees.',
        },
        {
          title: 'Physical Standards',
          description: 'No specific physical standard requirement except for certain services.',
        },
      ],
      selectionProcess: ['Prelims (CSAT)', 'Mains (Written)', 'Personality Test (Interview)'],
      vacancyTable: {
        columns: ['Post', 'Department', 'Vacancies', 'Pay Level', 'Salary'],
        rows: [
          { post: 'IAS', department: 'DoPT', vacancies: '180', payLevel: 'Level 10', salary: '₹56,100–₹2,50,000' },
          { post: 'IFS', department: 'MEA', vacancies: '37', payLevel: 'Level 10', salary: '₹56,100–₹2,50,000' },
          { post: 'IPS', department: 'MHA', vacancies: '200', payLevel: 'Level 10', salary: '₹56,100–₹2,50,000' },
          { post: 'IRS (IT)', department: 'CBDT', vacancies: '180', payLevel: 'Level 10', salary: '₹56,100–₹2,50,000' },
          { post: 'IRTS', department: 'Railways', vacancies: '10', payLevel: 'Level 10', salary: '₹56,100–₹2,50,000' },
          { post: 'Other Services', department: 'Various', vacancies: '326', payLevel: 'Various', salary: 'Various' },
        ],
      },
      howToApply: [
        'Open the official UPSC result PDF and check your roll number in the final merit list.',
        'Download and preserve the official PDF, then monitor UPSC for score card and cut-off updates.',
        'Use only the UPSC website for marks, topper list, and further official notices.',
      ],
      importantLinks: [
        {
          label: 'View Final Result PDF',
          href: '/results/upsc-civil-services-2025-final-result',
          emphasis: 'primary',
          note: 'Official result resource',
          type: 'result',
          icon: 'result',
        },
        { label: 'Check Individual Score', href: '/results/upsc-civil-services-2025-final-result', emphasis: 'secondary', type: 'apply', icon: 'apply' },
        { label: 'Cut-off Marks', href: '/results/upsc-civil-services-2025-final-result', emphasis: 'muted', type: 'download', icon: 'doc' },
        { label: 'Topper List & Marks', href: '/results/upsc-civil-services-2025-final-result', emphasis: 'muted', type: 'download', icon: 'doc' },
        { label: 'UPSC Official Website', href: 'https://upsc.gov.in/', emphasis: 'muted', type: 'website', icon: 'web' },
        { label: 'Download Official Notification', href: '/results/upsc-civil-services-2025-final-result', emphasis: 'muted', type: 'download', icon: 'pdf' },
        { label: 'Apply Online', href: 'https://upsc.gov.in/', emphasis: 'muted', type: 'apply', icon: 'apply' },
      ],
      qa: [
        {
          id: 1,
          ...
          answers: [
            ...
            },
            {
              ...
              initials: 'NG',
              avatarColor: '#00695c',
              text: "I applied in the previous cycle as a final year student. Just make sure your college issues a provisional certificate — that's also accepted during verification.",
              time: '1 day ago',
              likes: 9,
              liked: false,
            },
          ...
          answers: [
            {
              ...
              initials: 'AK',
              avatarColor: '#6a1b9a',
              text: 'Yes! Female candidates are fully exempted from paying the application fee regardless of their category (General / OBC / SC / ST). The fee is ₹0 for all women applicants.',
              time: '1 day ago',
              likes: 12,
              liked: false,
              isBest: true,
        ...
        },
        {
          ...
          initials: 'VS',
          avatarColor: '#880e4f',
          text: 'What is the age relaxation for OBC (NCL) candidates and how do I claim it?',
          time: '18 hours ago',
          likes: 11,
          liked: false,
          answers: [
            {
              ...
              initials: 'MY',
              avatarColor: '#e65100',
              text: "OBC (Non-Creamy Layer) candidates get 3 years of age relaxation over the upper age limit. You need to submit a valid OBC-NCL certificate issued within 1 year of the application date. Make sure the certificate explicitly says 'Non-Creamy Layer'.",
              time: '17 hours ago',
              likes: 8,
              liked: false,
              isBest: true,
      ...
      relatedPosts: [
        {
          title: 'SSC CHSL 2026 — Notification Out',
          tag: 'new',
          date: '26 Mar',
          href: '/jobs/ssc-cgl-2026-combined-graduate-level-exam',
          posts: '3,712',
          category: 'Latest Jobs',
        },
        {
          title: 'IBPS PO 2026 — Online Application',
          tag: 'hot',
          date: '25 Mar',
          href: '/jobs/ibps-po-2026-probationary-officer',
          posts: '4,455',
          category: 'Latest Jobs',
        },
        {
          title: 'Railway Group D — 32,000 Posts',
          tag: 'new',
          date: '24 Mar',
          href: '/jobs/railway-rrb-group-d-level-1-posts',
          posts: '32,000',
          category: 'Latest Jobs',
        },
        {
          title: 'UPSC NDA 2026 — Apply Before 30 Apr',
          tag: 'last-date',
          date: '23 Mar',
          href: '/jobs/upsc-nda-na-2026-national-defence-academy',
          posts: '400',
          category: 'Latest Jobs',
        },
        {
          title: 'Bihar Police Constable — 21,391 Posts',
          tag: 'hot',
          date: '22 Mar',
          href: '/jobs/bihar-police-constable-recruitment-2026',
          posts: '21,391',
          category: 'State Jobs',
        },
      ],
