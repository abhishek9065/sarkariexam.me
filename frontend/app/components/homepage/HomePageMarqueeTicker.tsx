...
const updates = [
  ...
  '⚔️ NDA 2026 Written Exam Result Out',
  ...
  return (
    <div className="border-b border-gray-200 bg-white shadow-sm">
      <div className="mx-auto flex max-w-6xl items-center">
        <div className="flex shrink-0 items-center gap-1.5 rounded-r-none bg-[#e65100] px-3 py-2">
          <Zap size={12} className="fill-yellow-200 text-yellow-200" />
          <span className="whitespace-nowrap text-[10px] font-extrabold tracking-wider text-white">
            LIVE UPDATES
          </span>
        </div>
